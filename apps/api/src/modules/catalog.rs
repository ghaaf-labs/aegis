...
fn curated_strategies() -> Vec<StrategySeed> {
    vec![
        StrategySeed {
            ...
            description: "Operating-cash treasury with a yield-bearing T-Bill sleeve. Suited for teams and small businesses that need principal preservation but want USYC yield on idle USDC.",
            risk_band: "low",
        ...
        StrategySeed {
            ...
            name: "Balanced",
            description: "Long-only stablecoin-anchored portfolio with majors exposure. Half the book sits in income-generating USDC and USYC; the other half rides BTC and ETH for asymmetric upside.",
            risk_band: "medium",
        ...
        StrategySeed {
            ...
            description: "Multi-currency reserve for an internet-native organization with multi-jurisdiction operating expenses. USDC and EURC keep payroll in either denomination; USYC carries the yield sleeve.",
            risk_band: "low",
