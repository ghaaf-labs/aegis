        ...
        return (
          ...
          >
            <header className="flex items-center justify-between mb-3">
              <BrutalPill tone="agent">{t.name.toUpperCase()}</BrutalPill>
            ...
            <dl className="space-y-1.5 text-xs font-mono text-text-default mb-5">
              ...
              <Row label="Portfolios" value={formatLimit(t.portfolioCap, "")} />
              <Row
                label="Decisions / mo"
                value={formatLimit(t.decisionsPerMonth, "")}
              />
            ...
            {onSelect ? (
              <BrutalButton
                ...
                aria-label={
                  isCurrent ? `Currently on ${t.name}` : `Upgrade to ${t.name}`
                }
              >
                {isCurrent
                  ? "Current plan"
