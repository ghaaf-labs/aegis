...
export function ReviewStep({ formData }: Props) {
  ...
  const allocations =
    formData.initialAllocations.length > 0
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-start gap-3 p-4 rounded-xl bg-emerald-500/5 border border-emerald-500/15">
        ...
        <p className="text-xs text-gray-400 leading-relaxed">
          Aegis AI will monitor your portfolio 24/7, alert you to significant
          market movements, and suggest rebalances when your allocations drift
          beyond thresholds. You stay in control — all trades require your
          approval.
        </p>
      </div>
    </div>
