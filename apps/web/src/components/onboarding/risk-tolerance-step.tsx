...
const OPTIONS: Array<{
...
}> = [
  {
    ...
    label: "Conservative",
    description:
      "Capital preservation. Lower volatility, slower growth. Minimal crypto exposure.",
    icon: Shield,
  ...
  },
  {
    ...
    label: "Moderate",
    description:
      "Balanced risk-reward. Mix of stable and growth assets. Recommended for most.",
    icon: TrendingUp,
    color: "text-blue-400",
  },
  {
    ...
    label: "Aggressive",
    description:
      "Maximum growth potential. High volatility accepted. Strong stomach required.",
    icon: Zap,
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-400">
          This shapes how Aegis rebalances your portfolio and evaluates
          trade-offs.
        </p>
      </div>
