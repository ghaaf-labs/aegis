...
// longer leak demo data into the production paths, so unauthenticated users
// must see the actual continue CTA, not pre-populated
// portfolio cards.

test("landing page advertises explore + continue", async ({ page }) => {
  await page.goto("/");
