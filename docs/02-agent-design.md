...
| ----------------------------------- | -------------------------------------------------------------- |
| `fetch_news(symbol, hours)`         | When proposing to _increase_ an allocation; sanity check       |
...
> _You are a risk-averse counterparty. The strategist has proposed a rebalance. Find the strongest case against it: what regime change would invalidate it, what correlation it ignores, what tax cost it overlooks. If it survives your critique, say so. Be specific._
